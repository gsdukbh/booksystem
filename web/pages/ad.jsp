...
<div class="am-g tpl-g">
            ...
            <div class="am-fr tpl-header-navbar">
                <ul>
                    ...
                    <li class="am-text-sm tpl-header-navbar-welcome">
                        <a href="#">欢迎你, <span>Admin</span> </a>
                    </li>

                    <%--<!-- 新邮件 -->
                    <li class="am-dropdown tpl-dropdown" data-am-dropdown>
                        <a href="#" class="am-dropdown-toggle tpl-dropdown-toggle" data-am-dropdown-toggle>
                           &lt;%&ndash; <i class="am-icon-envelope"></i>&ndash;%&gt;
                            <i class="am-icon-bell"></i>

                            <span class="am-badge am-badge-success am-round item-feed-badge">${number}</span>
                        </a>
                        <!-- 弹出列表 -->
                    ...
                    <li class="am-dropdown" data-am-dropdown>
                        <a href="#" class="am-dropdown-toggle" data-am-dropdown-toggle>
                            ...
                            <span class="am-badge am-badge-warning am-round item-feed-badge">${number}</span>
                        </a>
    ...
    <div class="left-sidebar">
        ...
        <div class="tpl-sidebar-user-panel">
            <div class="tpl-user-panel-slide-toggleable">
                <div class="tpl-user-panel-profile-picture">
                    <img src="${pageContext.request.contextPath}/images/user07.png" alt="">
                </div>
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-nav-link">
                <a href="${pageContext.request.contextPath}/book/list.action" target="table" class="sidebar-nav-sub-title">
                ...
                <ul class="sidebar-nav sidebar-nav-sub">
                    ...
                    <li class="sidebar-nav-link">
                        <a href="${pageContext.request.contextPath}/toUpBook.action" target="table">
                            <span class="am-icon-angle-right sidebar-nav-link-logo"></span> 图书上传
                        </a>
                    </li>
                </ul>
            </li>
            <li class="sidebar-nav-link">
                <a href="${pageContext.request.contextPath}/read/list.action" target="table" class="sidebar-nav-sub-title">
                    <i class="am-icon-calendar sidebar-nav-link-logo"></i> 读者管理
                    <span class="am-icon-chevron-down am-fr am-margin-right-sm sidebar-nav-sub-ico"></span>
                </a>
                <ul class="sidebar-nav sidebar-nav-sub">
                    <li class="sidebar-nav-link">
                        <a href="${pageContext.request.contextPath}/toFindReader.action" target="table">
                            <span class="am-icon-angle-right sidebar-nav-link-logo"></span> 读者查找
                        </a>
                    </li>

                    <li class="sidebar-nav-link">
                        <a href="${pageContext.request.contextPath}/toUpReader.action" target="table">
                            <span class="am-icon-angle-right sidebar-nav-link-logo"></span> 读者信息上传
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="sidebar-nav-link">
                <a href="${pageContext.request.contextPath}/borrow/list.action" target="table" class="sidebar-nav-sub-title">
                    <i class="am-icon-bar-chart sidebar-nav-link-logo"></i> 借阅信息
                    <span class="am-icon-chevron-down am-fr am-margin-right-sm sidebar-nav-sub-ico"></span>
                </a>
                <ul class="sidebar-nav sidebar-nav-sub">
                    <li class="sidebar-nav-link">
                        <a href="${pageContext.request.contextPath}/toFindBorrow.action" target="table">
                            <span class="am-icon-angle-right sidebar-nav-link-logo"></span> 借阅查找
                        </a>
                    </li>
    ...
    <div class="tpl-content-wrapper">
            ...
            <div class="row">
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                    <div class="page-header-heading">
                        <span class="am-icon-home page-header-heading-icon"></span> 纸媒书城首页 <small>welcome</small></div>
        ...
        <div class="row-content am-cf">
            ...
            <div class="am-u-sm-12 am-u-md-12 am-u-lg-12" id="show">
             <iframe name="table" frameborder="0" width="100%" height="1080px">
